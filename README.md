...
- **Repo Kümesi:** `lending-core`
- **Bounded Context:** `lending`
- **Ana Capability:** Loan lifecycle business orchestration
- **Dönüşüm Wave:** 3
...
- `Loan lifecycle business orchestration` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
